...
class Params:
    ...
    def __init__(self):
        self.data_dir = Path(os.path.abspath(os.path.dirname(__file__)))
        self.bert_model_dir = './bert-uncased'
        self.ex_dir = self.data_dir / f'experiments/ex1'
        self.model_dir = self.data_dir / f'model/ex1'
        ...
        self.rel2idx = json.load(open('/kaggle/input/rrgat-data/rel2id.json', 'r', encoding='utf-8'))[-1]
